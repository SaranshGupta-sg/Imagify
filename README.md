...
- 🖼️ **AI Image Generation** — Convert text prompts into images via the ClipDrop API
...
- 🛡️ **Protected Routes** — Authenticated API requests across all sensitive endpoints
